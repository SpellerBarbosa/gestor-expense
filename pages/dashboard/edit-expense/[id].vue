...
onMounted(async () => {
  try {
    ...
    expense.value.descryption = data.expense.description;
...
<template>
  ...
  >
    ...
    >
      <form
        class="w-[90%] h-[100%] bg-blue-600 rounded-3xl flex flex-col items-center justify-evenly lg:shadow-2xl lg:shadow-blue-500"
      >
        <label class="w-[80%] flex flex-col gap-3" for="date">
          <span class="uppercase font-semibold tracking-wider text-white"
            >Data Lançamento:
          </span>
          <input
        ...
        <label class="w-[80%] flex flex-col gap-3" for="descryption">
          <span class="uppercase font-semibold tracking-wider text-white"
            >Descrição</span
          >
          <input
            ...
            :disabled="edit"
            type="text"
            v-model="expense.descryption"
          />
        </label>
        <label class="w-[80%] flex flex-col gap-3" for="payment">
          <span class="uppercase font-semibold tracking-wider text-white"
        ...
        <label class="w-[80%] flex flex-col gap-3" for="value">
          <span class="uppercase font-semibold tracking-wider text-white"
            >valor</span
          >
          <input
        ...
        <div class="flex gap-5">
          ...
          <button
            ...
            :class="
              save
                ? 'block bg-green-600 text-white rounded-2xl text-shadow-2xs'
                : 'hidden'
            "
          >
            salvar
